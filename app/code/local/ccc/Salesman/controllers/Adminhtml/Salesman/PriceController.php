<?php
<?php 
class Ccc_Salesman_Adminhtml_Salesman_PriceController extends Mage_Adminhtml_Controller_Action
{
	public function updateAction()
	{
		try
		{
			...
			{
				$modelSalesmanPrice1 =Maze::getModel('Salesman_Price');
				...
				{
					$modelSalesmanPrice =Maze::getModel('Salesman_Price');
