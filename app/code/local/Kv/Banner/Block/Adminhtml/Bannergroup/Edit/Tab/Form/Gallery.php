<?php
class Kv_Banner_Block_Adminhtml_Bannergroup_Edit_Tab_Form_Gallery extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getContentHtml()
    {
        ...
        $content = Mage::getSingleton('core/layout')
            ->createBlock('banner/adminhtml_bannergroup_edit_form_gallery_content');
