 ...
 */
class Kv_Eavmgmt_Block_Adminhtml_Eavmgmt_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper('eavmgmt')->__('Manage Eavmgmt');
